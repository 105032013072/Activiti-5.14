...
public interface RuntimeService {
   ...
   * @param associatedBizKey  业务标识
   * @param previousProcessInstId 前一个流程实例ID
   * @return
   */
  ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId,String associatedBizKey,String previousProcessInstId,String processStarter);
  ...
  * @return
  */
  ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId,String businessKey,String associatedBizKey,String previousProcessInstId,String processStarter);
   ...
   * @return
   */
  ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId,Map<String, Object> variables,String associatedBizKey,String previousProcessInstId,String processStarter);
   ...
   * @return
   */
  ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId,String businessKey, Map<String, Object> variables,String associatedBizKey,String previousProcessInstId,String processStarter);
