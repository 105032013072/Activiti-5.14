...
@Override
public ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId, String associatedBizKey,
		String previousProcessInstId,String processStarter) {
	
	return commandExecutor.execute(new StartProcessInstanceCmd<ProcessInstance>(null, processDefinitionId, null, null, associatedBizKey, previousProcessInstId,processStarter));
}

@Override
public ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId, String businessKey,
		String associatedBizKey, String previousProcessInstId,String processStarter) {
	
	return commandExecutor.execute(new StartProcessInstanceCmd<ProcessInstance>(null, processDefinitionId, businessKey, null, associatedBizKey, previousProcessInstId,processStarter));
}

@Override
public ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId, Map<String, Object> variables,
		String associatedBizKey, String previousProcessInstId,String processStarter) {
	
	return commandExecutor.execute(new StartProcessInstanceCmd<ProcessInstance>(null, processDefinitionId, null, variables, associatedBizKey, previousProcessInstId,processStarter));
}
@Override
public ProcessInstance startProcessInstanceByIdWithBizKey(String processDefinitionId, String businessKey,
		Map<String, Object> variables, String associatedBizKey, String previousProcessInstId,String processStarter) {
	
	return commandExecutor.execute(new StartProcessInstanceCmd<ProcessInstance>(null, processDefinitionId, businessKey, variables, associatedBizKey, previousProcessInstId,processStarter));
}
}
