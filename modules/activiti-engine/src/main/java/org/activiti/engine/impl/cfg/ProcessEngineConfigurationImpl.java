...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {  
  ...
  protected void initSessionFactories() {
    if (sessionFactories==null) {
      ...
      //====extention
      addSessionFactory(new GenericManagerFactory(BizCommentEntityManager.class));
      addSessionFactory(new GenericManagerFactory(AssociatedProcdefEntityManager.class));
    }
