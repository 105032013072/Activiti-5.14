...
public interface HistoryService {
   ...
   * @return
   */
  List<BizComment> getBizCommentsAfterTask(String businessKey);
   ...
   * @param advice 审批意见
   */
  void addBizComments(String taskId,String msg,String userId,String advice);
  
  void deleteBizComment(String taskId);
