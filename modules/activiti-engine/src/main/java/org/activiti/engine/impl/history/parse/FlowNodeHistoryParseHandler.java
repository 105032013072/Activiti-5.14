...
import org.activiti.engine.impl.bpmn.parser.handler.ActivityCompleteForCommentHandler;
...
public class FlowNodeHistoryParseHandler implements BpmnParseHandler {
  ...
  public void parse(BpmnParse bpmnParse, BaseElement element) {
    ...
    if(element instanceof BoundaryEvent) {
    	...
    	activity.addExecutionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, new ActivityCompleteForCommentHandler());
    }
  }
